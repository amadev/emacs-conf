...
(global-set-key [remap man] 'helm-man-woman)
#+END_SRC

Fallback to old find-file mode for tramp.

#+BEGIN_SRC elisp
(defun helm-old-ff (&optional no-op) (interactive)
...
(setq org-agenda-files
      (mapcar
       ...
       '("task.org" "bookmark.org" "reference.org" "google-calendar.org" "book.org" "film.org")))
#+END_SRC
...
- org babel multiline string with session is not supported
