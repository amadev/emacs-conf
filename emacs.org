...
(setq backend-ollama-local (gptel-make-ollama "ollama-local" :host "localhost:11434" :stream t :models '("qwen3:latest" "llama3.2:1b" "mistral:latest" "gemma3:4b" "TinyLlama:latest")))
